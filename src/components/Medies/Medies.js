  ...
  return (
    <>
      <header>
        <nav>
          <div class="logo">
            <img src="logo.png" alt="MedCare Logo" v />{" "}
          </div>
          <ul>
            <li>Home</li>
            <li>Services</li>
      ...
      <main>
        <section class="services">
          ...
          <div class="service-grid">
            ...
            <div class="service">
              <i class="fas fa-user-md"></i> <h3>Expert Diagnosis</h3>
              <p>Accurate assessments and personalized treatment plans.</p>
            </div>

            <div class="service">
              <i class="fas fa-heartbeat"></i> <h3>Wellness Programs</h3>
              <p>Preventative care and health promotion strategies.</p>
            </div>
          </div>
        </section>
        ...
        <section class="about-us">
          <h2>About Us</h2>
          <p>
            MedCare is committed to providing high-quality, patient-centered
            care. Our team of experienced medical professionals is dedicated to
